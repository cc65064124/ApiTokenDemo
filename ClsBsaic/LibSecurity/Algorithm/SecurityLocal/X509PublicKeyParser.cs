using ClsBsaic.LibSecurity.Algorithm.TriplDes;
using System;
using System.Collections.Generic;
using System.Linq;
using System.Text;

namespace ClsBsaic.LibSecurity.Algorithm.securitylocal
{
    ...
    {
        //获取公钥字节数组
        public static CWRSAParameters GetRSAPublicKeyParameters(byte[] bytes)
        {
            return GetRSAPublicKeyParameters(bytes, 0);
        }
        //获取公钥字节数组
        public static CWRSAParameters GetRSAPublicKeyParameters(byte[] bytes, int i)
        {
        ...
        private static CWRSAParameters LoadKeyData(byte[] abyte0, int i, int j, byte[] abyte1, int k, int l)
        {
            byte[] modulus = null;
            ...
            CWRSAParameters p = new CWRSAParameters();
            p.Modulus = modulus;
